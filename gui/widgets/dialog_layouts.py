...
class ModelGroupBox(QGroupBox):
    def __init__(self,model_name='',parent=None,
        ...
        self.spin_nr_periods.setRange(1,1000)
        ...
        self.spin_period_length.setRange(0,10000)
        ...
        self.spin_gap.setRange(0,10000)
        ...
        self.spin_longitudinal_distance.setRange(0,100)
        ...
        self.spin_mr.setRange(-10000,10000)
...
class MagneticFieldEditWidget(QWidget):
    ...
    def __init__(self, field_kwargs):
        ...
        for i, coord in [(0,"x"), (3,"y"), (6,"z")]:
            ...
            spin_coord.setRange(-10000,10000)
            ...
            spin_start.setRange(-10000,10000)
...
class TrajectoryEditWidget(QWidget):
    ...
    def __init__(self, traj_kwargs):
        ...
        self.spin_zmax.setRange(-10000,10000)
...
class IntegralsEditWidget(QWidget):
    ...
    def __init__(self, integrals_kwargs):
        ...
        self.spin_z_list_start.setRange(-10000,10000)
        ...
        self.spin_z_list_end.setRange(-10000,10000)
        ...
        self.spin_z_list_step.setRange(-100,100)
...
class IntegralsHEditWidget(QWidget):

    def __init__(self, integralsH_kwargs):
        super().__init__()

        z, x, y = integralsH_kwargs.values()

        gridIntegralsH = QGridLayout(parent=self)
        gridIntegralsH.setSpacing(0)

        label_calc_field_integrals_vs_x = QLabel("calc_field_integrals_vs_x")
        label_calc_field_integrals_vs_x.setFont(fontConsolas10)
        label_leftparenthesis = QLabel("(")
        label_leftparenthesis.setFont(fontConsolas14)
        label_leftparenthesis.setSizePolicy(sizeFixed,sizePreferred)
        ...
        self.spin_zstart.setRange(-10000,10000)
        ...
        self.spin_zend.setRange(-10000,10000)
        ...
        self.spin_zstep.setRange(-100,100)
        ...
        self.spin_xstart.setRange(-10000,10000)
        ...
        self.spin_xend.setRange(-10000,10000)
        ...
        self.spin_xstep.setRange(-100,100)
        ...
        for row in [0,1,3,4]:
            ...
            label_comma.setFont(fontConsolas10)
            label_comma.setSizePolicy(sizeFixed,sizePreferred)
            gridIntegralsH.addWidget(label_comma,row,5)
        ...
        gridIntegralsH.addWidget(label_calc_field_integrals_vs_x,0,0,alignHCenter)
        gridIntegralsH.addWidget(label_leftparenthesis,0,1)
        gridIntegralsH.addWidget(label_z,0,2,alignRight)
        gridIntegralsH.addWidget(label_zstart,0,3)
        gridIntegralsH.addWidget(self.spin_zstart,0,4)
        gridIntegralsH.addWidget(label_zend,1,3,alignRight)
        gridIntegralsH.addWidget(self.spin_zend,1,4)
        gridIntegralsH.addWidget(label_zstep,2,3,alignRight)
        gridIntegralsH.addWidget(self.spin_zstep,2,4)
        gridIntegralsH.addWidget(label_zrightbracket,2,5)
        gridIntegralsH.addWidget(label_x,3,2,alignRight)
        gridIntegralsH.addWidget(label_xstart,3,3,alignRight)
        gridIntegralsH.addWidget(self.spin_xstart,3,4)
        gridIntegralsH.addWidget(label_xend,4,3,alignRight)
        gridIntegralsH.addWidget(self.spin_xend,4,4)
        gridIntegralsH.addWidget(label_xstep,5,3,alignRight)
        gridIntegralsH.addWidget(self.spin_xstep,5,4)
        gridIntegralsH.addWidget(label_xrightbracket,5,5)
        gridIntegralsH.addWidget(label_y,6,2,alignRight)
        gridIntegralsH.addWidget(self.spin_y,6,4)
        gridIntegralsH.addWidget(label_rightparenthesis,6,5)
...
class AnalysisLayout(QVBoxLayout):
    def __init__(self, params_kwargs, parent=None):
        ...
        self.editIntegrals = IntegralsEditWidget(params_kwargs["Cumulative Integrals"])
        self.editIntegralsH = IntegralsHEditWidget(params_kwargs["Field Integrals vs X"])
        ...
        tabs.addTab(self.editIntegrals, "Edit Cumulative Integrals")
        tabs.addTab(self.editIntegralsH, "Edit Field Integrals vs X")
...
class ShortcutsLayout(QVBoxLayout):
    ...
    def __init__(self, parent=None) -> None:
        ...
        gridShortcuts.addWidget(QLabel("Esc key"),8,0,alignCenter)
