...
class Block(_fieldsource.FieldModel):
    ...
    PREDEFINED_SHAPES = {
        ...
        'papu_21': [
                [
                    [-23.5, 0], [-25.5, -2], [-25.5, -8.96], [-22.9, -11.56],
                    [22.9, -11.56], [25.5, -8.96], [25.5, -2], [23.5, 0]],
                [
                    [-22.9, -11.56], [-22.9, -13.44],
                    [22.9, -13.44], [22.9, -11.56]],
                [
                    [-22.9, -13.44],  [-25.5, -16.04], [-25.5, -23], [-23.5, -25],
                    [23.5, -25], [25.5, -23], [25.5, -16.04], [22.9, -13.44]]],
        'hybrid_block': [
            [
